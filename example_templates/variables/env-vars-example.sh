...
TF_VAR_windowsAgentAdminUsername="Your Windows admin user name for accessing K8s master nodes (Windows deployment)"
TF_VAR_windowsAgentAdminPassword="Your Windows password user name for accessing K8s master nodes (Windows deployment)"
